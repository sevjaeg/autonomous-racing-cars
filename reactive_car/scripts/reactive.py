...
class DisparityExtender:
    ...
    def filter_ranges(self, data):
        ...
        while i < (len(data.ranges) - 1):
            if data.ranges[i] > LIDAR_RANGE:
                data.ranges[i] = LIDAR_RANGE
            i +=1
    ...
    def navigate_farthest(self, ranges):
        ...
        print("straight ", straight, " farthest ", ranges_list[farthest])
        ...
        if BASIC_VELOCITY:
            ...
            velocity = farthest * VELOCITY_GAIN
            print(velocity)
